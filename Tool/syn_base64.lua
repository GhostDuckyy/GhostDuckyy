if syn then
   ...
   function Module:obfuscate(str)
         ...
         local obfuscated = "return(function("..variable[1]..","..variable[2]..","..variable[3]..")"..'\n      '..variable[1].." = {"..fake_encoded[1]..", "..encoded..", "..fake_encoded[2].."}; "..variable[2].." = loadstring("..bytes..")(); "..variable[3].." = "..variable[2]..":decode("..variable[1].."[2]); loadstring("..variable[3]..")()"..'\n'.."end)()"
